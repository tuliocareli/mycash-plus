...
/**
 * Splash Screen corrigida para o Purso.
 * Em vez de imagem, usa o código SVG direto para pintar apenas o porquinho de branco
 * e manter o fundo verde lima limpo.
 */
    ...
    return (
        ...
        >
            <div className="relative animate-pulse-slow">
                {/* SVG Oficial Injetado Diretamente */}
                <svg 
                    width="140" 
                    height="140" 
            ...
            `}>
                <span className="font-['Bebas_Neue'] text-2xl tracking-widest text-[#000000]/60">
                    PURSO
                </span>
            </div>
